...
//Route::post('/', 'PagesController@crear')->name('permisos.crear');
...
//PASO 2 :se inventa una ruta con el id que se pasa, para la secion de ->name= tota el valor de la ruta definida en el paso 1, 
//PASO 3 ir a pagesController y crear el "@editar" --> pagesgcontroller@editar
